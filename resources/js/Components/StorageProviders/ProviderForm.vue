<template>
    <form @submit.prevent="submit">
        <div>
            <label for="label" class="block font-medium text-sm text-gray-700"
                >Label</label
            >
            <input
                id="label"
        ...
        <div class="mt-4">
            <label for="driver" class="block font-medium text-sm text-gray-700"
                >Driver</label
            >
            <select
                id="driver"
                v-model="form.configuration.driver"
                class="mt-1 block w-full"
                required
            >
        ...
        <div v-if="form.configuration.driver === 's3'" class="mt-4">
            <label for="s3_key" class="block font-medium text-sm text-gray-700"
                >S3 Key</label
            >
            <input
                id="s3_key"
                v-model="form.configuration.key"
                type="text"
                class="mt-1 block w-full"
                required
            />
            ...
            <input
                id="s3_secret"
                v-model="form.configuration.secret"
                type="password"
                class="mt-1 block w-full"
                required
            />
            ...
            <input
                id="s3_region"
                v-model="form.configuration.region"
                type="text"
                class="mt-1 block w-full"
                required
            />
            ...
            <input
                id="s3_bucket"
                v-model="form.configuration.bucket"
                type="text"
                class="mt-1 block w-full"
                required
            />
